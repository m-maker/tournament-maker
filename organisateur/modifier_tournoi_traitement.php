...
if (isset($_GET["tournoi"]) && !empty($dpt) && !empty($cp) && !empty($ville) && !empty($adresse) && !empty($nom_lieu) && !empty($titre) && !empty($joueurs_max) && !empty($tarif) && !empty($event_date)) {
    ...
    $req_organiser_tournoi->bindValue(":event_tarif", $tarif, PDO::PARAM_INT);
    ...
    $req_organiser_tournoi->bindValue(":event_prive", $restriction, PDO::PARAM_BOOL);
    ...
    $req_organiser_tournoi->bindValue(":event_id", $id_tournoi, PDO::PARAM_INT);
