            ...
            foreach ($liste_all as $event){
                ...
                <div class="recap-event">
                    ...
                    <div class="conteneur-tournoi"
                         style="border-radius:0;width: 100%;margin:0;padding: 1%;">
                        <div class="row">
                            <div class="col-lg-4" style="text-align: left;">
                                <p><span class="glyphicon glyphicon-home"></span> Nom du complexe :
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="text-align: right; padding: 2% 10% 1%;">
                            <a href="feuille_de_tournois.php?tournoi=<?php echo $event["event_id"]; ?>">
                                <button class="btn btn-success btn-grand">Voir</button>
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="recap-event">
                                    ...
                                    <div class="conteneur-tournoi"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4" style="text-align: left;">
                                                <p><span class="glyphicon glyphicon-home"></span> Nom du complexe :
                                                    <span class="bold"><?php echo $lieu["lieu_nom"]; ?></span></p>
                                                <p><span class="glyphicon glyphicon-euro"></span> Paiement en ligne :
                                                    <span class="bold"> <?php echo $pay; ?></span></p>
                                                <p><span class="glyphicon glyphicon-user"></span><span
                                                            class="bold"> <?php echo compte_equipes($event['event_id']) . ' / ' . $event['event_nb_equipes']; ?></span>
